...
export default function Feed() {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen" style={{ backgroundColor: 'rgba(231, 231, 231, 0.33)' }}>
      {/* Sidebar - Desktop */}
      <aside className="hidden lg:flex flex-col w-[330px] text-white flex-shrink-0" style={{ backgroundColor: '#5B86FF' }}>
        ...
        <nav className="flex-1 pt-10 px-2">
          ...
          <div className="px-6 py-4 mb-1 hover:bg-white hover:bg-opacity-10 transition cursor-pointer">
            <div className="flex items-center gap-4">
              ...
              <span className="text-2xl font-normal leading-7">My Requests</span>
            </div>
          </div>
      ...
      <main className="flex-1 flex flex-col">
        ...
        <section className="flex-1 p-4 lg:p-0 lg:pt-8 lg:px-12 overflow-y-auto pb-24 lg:pb-8">
          ...
          <div className="mb-6 lg:mb-8">
            <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-2">Task Feed</h2>
          ...
          <div className="flex flex-col lg:flex-row gap-3 mb-6">
            <input
              ...
              style={{ backgroundColor: '#E7E7E7', color: 'rgba(0, 0, 0, 0.72)' }}
            />
            <select 
            ...
            <button className="flex items-center justify-center gap-3 px-8 py-3 text-white font-medium rounded-3xl transition hover:opacity-90" style={{ backgroundColor: '#2B5CE6' }}>
          ...
          <div className="space-y-5">
            {tasks.map((task, index) => (
              <div key={index} className="bg-white shadow-lg overflow-hidden" style={{ borderRadius: '31px' }}>
                <div className="flex flex-col md:flex-row gap-4 p-5">
                  ...
                  <div className="flex-1 flex flex-col">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="text-2xl lg:text-3xl font-medium text-black mb-2">{task.title}</h3>
                        <div className="flex items-center gap-2">
                          <span className="inline-block px-4 py-1 text-white text-base lg:text-xl font-medium rounded-full" style={{ backgroundColor: 'rgba(243, 172, 71, 0.99)' }}>
                            {task.category}
                          </span>
                          <span className="inline-block px-3 py-1 text-black text-sm font-normal rounded" style={{ backgroundColor: 'rgba(43, 230, 87, 0.52)' }}>
                            {task.price}
                          </span>
                        </div>
                      </div>
                      <button 
                        ...
                        style={{ backgroundColor: '#FFDCDB', border: '1px solid #E51C1C' }}
                      >
                        <Heart 
                          size={20} 
                    ...
                    {/* Location and Time */}
                    <div className="flex flex-col gap-1 text-sm lg:text-base mb-3" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>
                      <div className="flex items-center gap-2">
                        <MapPin size={18} className="text-gray-700" />
                        <span className="font-normal">{task.distance}</span>
                      </div>
                      <div className="flex items-center gap-2 pl-7">
                        <span className="w-1.5 h-1.5 rounded-full" style={{ backgroundColor: 'rgba(0, 0, 0, 0.61)' }}></span>
                    ...
                    <div className="flex items-center gap-1 mb-4">
                      <Star size={17} className="text-yellow-400" fill="#facc15" />
                      <span className="text-sm lg:text-base font-normal" style={{ color: 'rgba(0, 0, 0, 0.72)' }}>
                ...
                <div className="px-5 pb-5">
                  <button className="w-full py-3 text-white font-bold text-base rounded-3xl transition hover:opacity-90" style={{ backgroundColor: '#2B5CE6' }}>
                    Request Task
                  </button>
                </div>
              </div>
        ...
        <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t px-4 py-3 shadow-lg" style={{ borderColor: '#E0E0E0' }}>
          <div className="flex items-center justify-around relative">
            ...
            <button className="absolute -top-10 left-1/2 transform -translate-x-1/2 w-16 h-16 rounded-full flex items-center justify-center shadow-lg transition hover:opacity-90" style={{ backgroundColor: '#2B5CE6' }}>
